    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <header id="header" class="row">
            <nav id="navbar" class="row height-100 navbar-s navbar-light">
                ...
                <!--basic nav opts-->
                <div id="nav-link-cont" class="fl-left">
                    <ul id="nav-links-basic" class="row">
                        <li>
                        ...
                        <li>
                            ...
                            <!--<ul class="nav-innr-links row">
                                <li>
                                    <a href="/contact-us" id="customer">Customer</a>
                                </li>
                                
                                <li>
                                    <a href="/contact-us" id="partner">Partner</a>
                                </li>
                                
                                <li>
                                    <a href="/contact-us" id="employee">Employee</a>
                                </li>
                            </ul>-->
                        </li>
        ...
        <style>
            #main-banner{
                background-image:url('images/two-wheeler.jpg')
            }
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/two-wheeler-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    ...
                    <h1 id="ban-main-titl" class="row">Two Wheelers.</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Drive home the two wheeler of your choice and chase your dreams faster than ever.</p>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           No more standing in queues and no more suffering public transport delays. With our user-friendly two-wheeler loan plan, you are just a few steps away from owning a brand new two-wheeler. All you need to do is to look out for the Home Credit representative at the showroom and decide on loan terms as per your affordability and convenience.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <ul id="loan-features" class="row">
                                <li>
                                    ...
                                    <div class="row feature-text text1 ft-txt-disab">
                                        <p class="fl-left">
                                            Home Credit does not require you to have a credit card or have taken a loan before in your life to be eligible to apply for a two wheeler loan. Our simple, easy and fast loan application process can help you get finance and ride home on your dream bike!
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="fl-left feature-point">
                                            — Loans for top brands of Two Wheelers
                                        </div>
                                    ...
                                    <div class="row feature-text text2 ft-txt-disab">
                                        <p class="fl-left">
                                            You can walk into any Home Credit Two Wheeler dealer outlet and buy your dream bike, whatever the brand may be. Click here to locate the Home Credit dealer nearest to you.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text3 ft-txt-disab">
                                        <p class="fl-left">
                                            We believe that you are the best judge of your monthly family income and expenses and would never want your loan installment amount to be a burden to you.  Home Credit thus provides you the flexibility to select the repayment amount for your two wheeler loan that suits your pocket and allows you peace of mind.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text4 ft-txt-disab">
                                        <p class="fl-left">
                                            We at Home Credit are committed to ensure that the all details of your two wheeler loan have been accurately communicated and captured. While taking a loan from Home Credit, our representatives will make it a point to explain all the details related to your loan clearly and transparently. When taking two wheeler finance from Home Credit, you will receive a welcome kit including a Loan Summary that will contain all details such as such as loan amount, due date and monthly installment amount.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text5 ft-txt-disab">
                                        <p class="fl-left">
                                            Our friendly and multi lingual customer care staff is always just a call away at 1800 121 6660 to guide you along and help you with your two wheeler loan. The Home Credit call centre team reaches out to you in the language of your comfort and takes care to be your guiding partner throughout your loan tenure. 
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text6 ft-txt-disab">
                                        <p class="fl-left">
                                            Home Credit gives you the choice of Auto Debit from your bank account each month and online fund transfers or cash payment at a kiosk.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text7 ft-txt-disab">
                                        <p class="fl-left">
                                            We understand that each one of us likes to manage our money differently. That’s why Home Credit gives you the choice of Auto Debit from your bank account each month, online fund transfer or  cash payment at a kiosk! Read more on payment options.
                                        </p>
                                    </div>
                                </li>
                ...
                <div id="footer-bottom-bar" class="row">
                    <div class="-fl-left">
                        <ul id="bottom-links" class="fl-left bottom-links-common">
                            ...
                            <li>
                                <a href="https://www.homecredit.co.in/visual/other/rbi-disclaimer.jpg" target="_blank">
                                    RBI DISCLAIMER
                                </a>
                            </li>
