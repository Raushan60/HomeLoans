        ...
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    ...
                    <p id="banner-text" class="fl-left clear-all">With our quick and simple process getting a response for your query/feedback is quite simple indeed.</p>
            ...
            <section id="apply-now-form-cont" class="row sec-pad-bt">
                <div id="apply-now-form-inr" class="row narrow-row">
                    <form method="post" action="apply_for_feedback.jsp" id="apply-now-form" class="row">
						...
						<div class="row">
                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="text" name="feedback" placeholder="Please give feedback or any query*" required>
                            </div>
