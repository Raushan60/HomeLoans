...
<head>
    ...
    <meta name="csrf-token" content="bdgXvuAHiJuF5UIgQyogbfLRGrMf1sFkC9w3Yj14" />
                    ...
                    <li>
                        <div class="row menu-main-link">
                            ...
                            <div class="menu-btns fl-right ft-close" data-target="text100">
                                <img src="imagefeat-open.png" class="row" id="ft-opn-btn">
                                <img src="imagefeat-close.png" class="row" id="ft-cls-btn">
                            </div>
                        </div>
                        ...
                        <div class="row feature-text text100 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                <li>
                                    <a href="our-vision.jsp" class="menu-inr-link">— VISION &amp; VALUES</a>
                                </li>
                                <li>
                                    <a href="our-customer-promise.jsp" class="menu-inr-link">— CUSTOMER PROMISE</a>
                                </li>
                                <li>
                                    <a href="our-people.jsp" class="menu-inr-link">— OUR PEOPLE</a>
                                </li>
                                <li>
        ...
        <div id="desk-menu-lines" class="row height-100">
            ...
            <div id="m-line-right" class="height-100">
                <div id="desk-menu-close" class="desk-menu-s">
                    <img src="imageclose_d.png" class="row">
                </div>
            </div>
                        ...
                        <li>
                            <div class="row dmenu-main-link">
                                ...
                                <div class="dmenu-btns fl-right ft-close" data-target="text120">
                                    <img src="imagedmenu-plus.png" class="row" id="ft-opn-btn">
                                    <img src="imagedmenu-minus.png" class="row" id="ft-cls-btn">
                                </div>
                            </div>
            ...
            <div id="pop-up-box" class="block block-left block-25 pop-box-s hv-center">
                ...
                <div id="log-switch" class="row">
                    ...
                    <span id="login-pop-close" class="login-pop-close-c fl-right">
                        <img src="imageclose-popup.png" class="row">
                    </span>
                </div>
                    ...
                    <form id="login-form" action="" method="post">
                        ...
                        <div class="row input-cover">
                            <div class="input-icon-cont">
                                <img src="imageuser.png" class="row">
                            </div>
                        ...
                        <div class="row input-cover">
                            <div class="input-icon-cont">
                                <img src="imagelock.png" class="row">
                            </div>
        ...
        <header id="header" class="row">
                ...
                <div id="other-ops-cont" class="fl-left v-center">
                    <ul id="other-ops" class="row">
                        ...
                        <li id="open-login" class="header-icon-bord disab">
                            <!--<img src="imagelogin.png" class="header-icon other-icon other-icon-disab" alt="hc-login">-->
                            <span class="header-icon-text">Login</span>
                        </li>
                        
                        <li id="open-search" class="header-icon-bord">
                            <img src="imagesearch-w.png" class="header-icon other-icon other-icon-disab" alt="hc-search">
                        </li>                                  
                        
                        <li id="share-module">
                            <!--<img src="imageheart.png" class="header-icon-bord  header-icon other-icon other-icon-disab" alt="hc-share">-->
                    ...
                    <div class="row talign-cent">
                        <div id="menu-icon" class="menu-icon-c">
                            <div class="menu-icon-inr row m-open-icon">
                                <img src="imagemenu.png" alt="hc-menu" class="row other-icon-disab">
                            </div>
                            
                            <div class="menu-icon-inr row m-close-icon">
                                <img src="imageclose_icon_w.png" alt="hc-menu" class="row other-icon-disab">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="search-field-cont" class="row disab-opa disab-out search-module">
                <div id="search-field-mag" class="fl-left height-100 search-field-icon">
                    <img src="imagesearch.png" class="row">
                </div>
                ...
                <div id="search-field-cross" class="fl-right height-100 search-field-icon close-search">
                    <img src="imageclose.png" class="row">
                </div>
        ...
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Start</span>
                    <h1 id="ban-main-titl" class="row">SHOPPING TODAY</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Easiest and fastest way to obtain loans for all your product requirements. </p>
                    ...
                    <div id="scroll-icon" class="scroll-icon-s fl-left">
                        <img id="scroll-up" src="imagemouseUp.svg" class="row scroll-up-s scroll-icon-disab">
                        <img id="scroll-down" src="imagemouseDn.svg" class="row scroll-down-s">
                    </div>
                </div>
            </section>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           We provide you with easily accessible loans for products ranging from Mobile Phones, Laptops, Home Appliances, Electronics and Two Wheelers. You can obtain these loans easily and take home the products immediately. Home Credit also gives you the option of choosing your monthly instalment amount, so as to not burden your wallet. The loans are provided at nominal interest rate and follow a very simple process, with minimal documentation. Visit any of our outlets scattered across the country for convenient and pocket-friendly shopping! 
                        </p>
                    </div>
                </div>
            </section>

            <section id="product-grid" class="row">

                <!--mobile block-->
                <div class="block-40 block-100-t block-100-m pro-grid block-left">

                    <div class="row height-100 grid-img" style="background-image:url('images/mobile.jpg')">
                    </div>

                    <div class="row height-100 grid-cont">
                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                        <h3 class="grid-titl row">Mobile Phone Loan</h3>
                        <a href="smartphone.jsp" class="grid-read-btn fl-left">READ MORE</a>
                        <a href="applynow.jsp" class="grid-read-btn grid-apply-now fl-left">APPLY NOW</a>
                    </div>

                </div>

                <!--two wheeler block-->
                <div class="block-60 block-100-t block-100-m pro-grid block-left">
                    <div class="row height-100 grid-img" style="background-image:url('images/twowheel.jpg')">
                    </div>

                    <div class="row height-100 grid-cont">
                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                        <h3 class="grid-titl row">TWO WHEELER LOAN</h3>
                        <a href="two-wheeler.jsp" class="grid-read-btn fl-left">READ MORE</a>
                        <a href="applynow.jsp" class="grid-read-btn grid-apply-now fl-left">APPLY NOW</a>
                    </div>
                </div>

                <!--home appliances block-->
                <div class="block-100 pro-grid block-left">
                    <div class="row height-100 grid-img" style="background-image:url('images/appliances.jpg')">
                    </div>

                    <div class="row height-100 grid-cont">
                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                        <h3 class="grid-titl row">HOME APPLIANCE LOAN</h3>
                        <a href="home-appliance.jsp" class="grid-read-btn fl-left">READ MORE</a>
                        <a href="applynow.jsp" class="grid-read-btn grid-apply-now fl-left">APPLY NOW</a>
                    </div>
                </div>
                ...
                <!--laptop block-->
                <div class="block-60 block-100-t block-100-m pro-grid block-left">
                    <div class="row height-100 grid-img" style="background-image:url('images/laptop.jpg')">
                    </div>

                    <div class="row height-100 grid-cont">
                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                        <h3 class="grid-titl row">LAPTOP LOAN</h3>
                        <a href="laptop.jsp" class="grid-read-btn fl-left">READ MORE</a>
                        <a href="applynow.jsp" class="grid-read-btn grid-apply-now fl-left">APPLY NOW</a>
                    </div>
                </div>
                ...
                <!--cash loan block-->
                <div class="block-40 block-100-t block-100-m pro-grid block-left">
                    <div class="row height-100 grid-img" style="background-image:url('images/loan.jpg')">
                    </div>

                    <div class="row height-100 grid-cont">
                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                        <h3 class="grid-titl row">MINI CASH LOAN</h3>
                        <a href="mini-cash-loan.jsp" class="grid-read-btn fl-left">READ MORE</a>
                        <a href="applynow.jsp" class="grid-read-btn grid-apply-now fl-left">APPLY NOW</a>
                    </div>
                </div>
