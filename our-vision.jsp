                    ...
                    <li>
                        ...
                        <div class="row feature-text text100 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                ...
                                <li>
                                    <a href="https://www.homecredit.co.in/visual/other/faq-logo.jpg" target="_blank" class="menu-inr-link">— FAQ LOGO</a>
                                </li> 
                            </ul>
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            ...
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('https://www.homecredit.co.in/visual/images/banner/mobile/vision-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    ...
                    <h1 id="ban-main-titl" class="row">vision &amp; values</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">We are here to help people realise their dreams.</p>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           To provide innovative retail financial services focusing on mass-retail segment.<br>
                           To help clients realise their dreams and ambitions in a financially secure way.<br>
                           To offer long-term, stable, and challenging work opportunities.<br>
                           To transform the way the world shops.<br>
                            ...
                            <ul id="loan-features" class="row">
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text4 ft-txt-disab">
                                        <p class="fl-left">
                                            We respect different opinions but are never shy of communicating our own. We take responsibility of our actions, we accept our mistakes to ensure it doesn’t happen again.
