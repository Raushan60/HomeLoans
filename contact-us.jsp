...
<head>
    ...
    <meta name="csrf-token" content="1ZDzmIaI3Hy97NE7hJcYlvM7BbJY3iUbBauSA1LQ" />
                        ...
                        <li>
                            ...
                            <div class="row feature-text text120 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    ...
                                    <li>
                                        <a href="https://www.homecredit.co.in/visual/other/faq-logo.jpg" target="_blank" class="dmenu-inr-link">— FAQ LOGO</a>
                                    </li>
                                </ul>
        ...
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Feedback</span>
                    <h1 id="ban-main-titl" class="row">Any Query??</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Contact us at care@homecredit.co.in and help us build an environment that inspires growth for everyone.</p>
                    <a href="feedback.jsp"  class="common-apply-now fl-left clear-all">CLICK HERE</a>
                ...
                <div id="abt-nav-dots" class="fl-left">
                    ...
                    <div id="abt-nav-line-cont-short-2" class="row">
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           We at Home Credit believe that our employees are the people who make Home Credit what it is. Each one of you is an asset and a partner in our growth story and as we stay committed to growing further together. To make the Home Credit Culture more employee-friendly it is important that you share your complaints and compliments.  
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="contact-opt-sec" class="row sec-pad-bt">
                <div class="row section-inr bg-r">

                    <div class="block-30 block-100-t block-100-m block-left">
                        
                        <ul id="contact-icons" class="row">
                            <li class="contact-icon">
                                <span class="contact-icon-btn fa fa-phone con-icon-actv" data-target="1"></span>
                                <span class="row con-icon-title">Call</span>
                            </li>
                            
                            <li class="contact-icon">
                                <span class="contact-icon-btn fa fa-envelope-o con-icon-disab" data-target="2"></span>
                                <span class="row con-icon-title">Email</span>
                            </li>
                            
                            <li class="contact-icon">
                                <span class="contact-icon-btn fa fa-send con-icon-disab" data-target="3"></span>
                                <span class="row con-icon-title">Letter</span>
                            </li>
                            
                            <li class="contact-icon">
                                <span class="contact-icon-btn fa fa-wpforms con-icon-disab" data-target="4"></span>
                                <span class="row con-icon-title">Online Form</span>
                            </li>
                        </ul>
                    ...
                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">
                        ...
                        <!--contact us tab 1-->
                        <div class="row contact-us-tab contact-us-tab-s con-tab-1">
                            <p class="contact-content-text content-text-r row">
                               Please give us missed call at:
                            </p>
                            
                            <h5 class="contact-tab-title">0124 – 483 – 7610</h5>

                            <!--list type basic-->
                            <div class="row list-basic-pad contact-tab-list">

                                    <ul class="row list-basic">
                                        <!--<li>(between 9:00am - 8:00pm 	Monday - Sunday)</li>
                                        <li>Please keep your Loan account number/registered Mobile number handy for verification.</li>-->
                                    </ul>               

                            </div>
                            
                            
                            <p class="content-text-b row">
                               Dissatisfied with our first resolution &nbsp; &nbsp;<a href="#" class="link-r">Click Here</a>
                            </p>
                        ...
                        <!--contact us tab 2-->
                        <div class="row contact-us-tab contact-us-tab-s con-tab-2 disab">
                            <p class="contact-content-text content-text-r row">
                               You can email us all your queries, concerns and suggestions at
                            </p>
                            
                            <h5 class="contact-tab-title">
                                <a href="mailto:myhr@homecredit.co.in" class="link-r">myHR@homecredit.co.in</a>
                            </h5>
                            
                            <p class="contact-content-text content-text-r row">
                               Please ensure you mention your name, employee ID, mobile number, and location in the email.
                            </p>
                            ...
                            <p class="content-text-b row">
                               Dissatisfied with our previous response &nbsp; &nbsp;<a href="https://www.homecredit.co.in/hco/ombudsperson.aspx" target="_blank" class="link-r">Click Here</a>
                            </p>
                        ...
                        <!--contact us tab 3-->
                        <div class="row contact-us-tab contact-us-tab-s con-tab-3 disab">
                            <p class="contact-content-text content-text-r row">
                            ...
                            <div class="row list-basic-pad contact-tab-list">
                                    ...
                                    <ul class="row list-basic">
                                        <li>myHR Team</li>
                                        <li>HR Operations</li>
                                        <li>Home Credit India Finance Private Limited</li>
                                        <li>DLF Infinity Towers, Tower C, 3rd Floor, DLF Cyber City Phase II, Gurgaon-122002, India</li>
                                    </ul>               
                        ...
                        <!--contact us tab 4-->
                        <div class="row contact-us-tab contact-us-tab-s con-tab-4 disab">
                            <p class="contact-content-text content-text-r row">
                               Our online form allows you to raise your queries, concerns, and suggestions in a convenient manner while being on our website itself.
                            </p>
                            ...
                            <div class="row list-basic-pad contact-tab-list">
                                    ...
                                    <ul class="row list-basic">
                                        <li><a href="#" class="link-r">Click Here</a> to access the online form.</li>
                                    </ul>               
                ...
                <div id="footer-bottom-bar" class="row">
                    ...
                    <div class="fl-right">
                        <span id="copyright-text" class="fl-right copyright-text-common">
                            © 2014 HOME CREDIT INDIA B. V. All Rights Reserved.
                        </span>
                    </div>
                </div>
