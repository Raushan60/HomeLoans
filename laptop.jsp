...
<head>
    ...
    <!--======dynamic seo tags======-->
            ...
            <title>Home Appliances Loan | Consumer Loan on EMI | Home Credit India</title>
        <meta name=“description” content=“Home Credit India offers zero interest EMI based loans for home and kitchen appliances. Finance refrigerator, AC, washing machine, LED TV on easy Instalment with us. “ />
        <meta name=“keyword” content=“home appliances loan, led tv loan on emi, kitchen appliances on finance, Air conditioner on EMI, washing machine on loan, fridge on emi, Consumer Loan on EMI, Home Credit India” />
                        ...
                        <li>
                            ...
                            <div class="row feature-text text120 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    ...
                                    <li>
                                        <a href="our-customer-promise.jsp" class="dmenu-inr-link">— CUSTOMER PROMISE</a>
                                    </li>
                                    <li>
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            ...
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/home-app-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    ...
                    <h1 id="ban-main-titl" class="row">home appliance</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Bring home a better lifestyle with Now the latest TVs, refrigerators and washing machines.</p>
            ...
            <!--home appliances second section-->
            <section class="row sec-pad-bt">
                <div class="row section-inr bg-r">
                    ...
                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">
                        ...
                        <!--list type basic-->
                        <div class="row list-basic-pad">
                            <div class="block-33 block-100-t block-100-m block-left block-pad-15-r">
                                <ul class="row list-basic">
                                    <li>— Air Conditioner</li>
                                    <li>— Air Coolers</li>
                                    <li>— Audio/Video Player</li>
                                    <li>— Battery</li>
                                    <li>— Clothes Drying Machine</li>
                                    <li>— CCTV</li>
                                    <li>— Dishwasher</li>
                                </ul>
                            </div>
                            ...
                            <div class="block-33 block-100-t block-100-m block-left block-pad-15-r">
                                <ul class="row list-basic">
                                    <li>— Domestic Flour Machine</li>
                                    <li>— LCD, flat TV, LED TV</li>
                                    <li>— Home Theatre</li>
                                    <li>— Inverter &amp; Battery</li>
                                    <li>— Domestic Kitchen Chimney</li>
                                    <li>— Microwave Oven</li>
                                    <li>— Oven, Stove, Hob, Plate</li>
                                </ul>
                            </div>
                            
                            <div class="block-33 block-100-t block-100-m block-left block-pad-15-r">
                                <ul class="row list-basic">
                                    <li>— Air Fryer, Geyser, Oil Heater</li>
                                    <li>— Plasma TV</li>
                                    <li>— Photo/Video Camera</li>
                                    <li>— Refrigerator, freezer</li>
                                    <li>— Vacuum Cleaner</li>
                                    <li>— Washing Machine</li>
                                    <li>— Water Purifiers/RO System</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul id="loan-features" class="row">
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text5 ft-txt-disab">
                                        <p class="fl-left">
                                            We at Home Credit are committed to ensure that the all details of your home appliance loanhave been accurately communicated and captured. While taking a loan from Home Credit, our representatives will make it a point to explain all the details related to your loan clearly and transparently. When taking home appliance finance from Home Credit, you will receive a welcome kit including a Loan Summary that will contain all details such as such as loan amount, due date and monthly installment amount.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text text6 ft-txt-disab">
                                        <p class="fl-left">
                                            Our friendly and multi lingual customer care staff is always just a call away at 1800 121 6660 to guide you along and help you with your home appliance loan. The Home Credit call centre team reaches out to you in the language of your comfort and takes care to be your guiding partner throughout your loan tenure.
                                        </p>
                                    </div>
                                </li>
