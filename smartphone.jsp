...
<head>
    ...
    <meta name="csrf-token" content="0BEg2OXKWSlZkgFRWq4aibYJfTqx4bL1gmHElfb8" />
    ...
    <!--======dynamic seo tags======-->
        ...
        <!--if smartphone page-->
        <title>Mobile Loan Online | Finance for Smartphone | Home Credit India</title>  
        <meta name=“description” content=“Get Mobile phone loans with zero interest-free EMI with Home Credit India. Finance your Smartphone with us at 0 percent interest with fast and easy loan approval. “ />
        <meta name=“keyword” content=“Mobile Loan, Finance for Smartphone, mobile finance, loan for mobile, mobile phone loans, mobile on emi, 0 interest emi on mobile phones, zero interest on mobile, Home Credit India” />
                ...
                <ul id="mob-menu-ul" class="row">
                    ...
                    <li>
                        ...
                        <div class="row feature-text text102 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                <li>
                                    <a href="smartphone.jsp" class="menu-inr-link">— MOBILE PHONE LOAN</a>
                                </li>
                                <li>
                                    <a href="two-wheeler.jsp" class="menu-inr-link">— TWO WHEELER LOAN</a>
                                </li>
                                <li>
                                    <a href="home-appliance.jsp" class="menu-inr-link">— HOME APPLIANCES LOAN</a>
                                </li>
                                <li>
                                    <a href="laptop.jsp" class="menu-inr-link">— LAPTOP LOAN</a>
                                </li>
                                <li>
                                    <a href="mini-cash-loan.jsp" class="menu-inr-link">— MINI CASH LOAN</a>
                                </li>                                
                            </ul>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="row menu-main-link">
                            <div class="fl-left menu-point">
                                <a href="applynow.jsp" target="_blank">LOAN</a>
                            </div>
                        ...
                        <div class="row feature-text text105 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                <li>
                                    <a href="applynow.jsp" class="menu-inr-link">— APPLY FOR LOAN</a>
                                </li>
                                <li>
                    ...
                    <ul id="mob-menu-ul" class="row v-center">
                        ...
                        <li>
                            ...
                            <div class="row feature-text text121 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    <li>
                                        <a href="smartphone.jsp" class="dmenu-inr-link">— MOBILE PHONE LOAN</a>
                                    </li>
                                    <li>
                                        <a href="two-wheeler.jsp" class="dmenu-inr-link">— TWO WHEELER LOAN</a>
                                    </li>
                                    <li>
                                        <a href="home-appliance.jsp" class="dmenu-inr-link">— HOME APPLIANCES LOAN</a>
                                    </li>
                                    <li>
                                        <a href="laptop.jsp" class="dmenu-inr-link">— LAPTOP LOAN</a>
                                    </li>
                                    <li>
                                        <a href="mini-cash-loan.jsp" class="dmenu-inr-link">— MINI CASH LOAN</a>
                                    </li>                                
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="row feature-text text124 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    <li>
                                        <a href="applynow.jsp" class="dmenu-inr-link">— APPLY FOR LOAN</a>
                                    </li>
                                    <li>
    ...
    <div id="wrapper" class="row disab-opa">
            ...
            <nav id="navbar" class="row height-100 navbar-s navbar-light">
                ...
                <div id="logo" class="fl-left height-100">
                    <a href="/" class="row height-100">
                       <img src="images/logo-svg.svg" class="fl-left height-100" alt="HomeCredit"> 
                    </a>
                </div>
        ...
        <style>
            ...
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/mobile-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Instant Loan for</span>
                    <h1 id="ban-main-titl" class="row">SMARTPHONES</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Take a Mobile Phone Loan from Home Credit today and stay connected forever.</p>
                    <a href="applynow.jsp" id="banner-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           Home Credit’s smartphone finance solution is meant to make life simple for you and help you realize your aspiration, of owning the coolest smartphone on the block, in just a few easy steps. With our loan for smartphone you can upgrade your lifestyle by reaching out for the top end devices that felt like a distant possibility before.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="product-features-main" class="row">
                <div id="product-feature-inr" class="row">

                    <div class="fat-lines fl-left"></div>

                    <div id="product-features" class="row">

                        <!--feature banner-->
                        <div id="feature-left" class="fl-left">
                            <img src="images/featback.jpg" alt="homeCredit" class="row">
                        </div>

                        <div id="feature-right" class="fl-left">
                            <h3 id="feature-title" class="row">
                                LOAN FEATURES
                            </h3>
                            <span class="content-bord cont-bord-wht cont-bord-mar2 fl-left"></span>

                            <!--feature list begins-->
                            <ul id="loan-features" class="row">
                                <li>
                                    <div class="row">
                                        <div class="fl-left feature-point">
                                            — On-The-Spot Loans
                                        </div>

                                        <div class="feature-btns fl-right ft-close" data-target="text1">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text1 ft-txt-disab">
                                        <p class="fl-left">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text2">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text2 ft-txt-disab">
                                        <p class="fl-left">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text3">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text3 ft-txt-disab">
                                        <p class="fl-left">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text4">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text4 ft-txt-disab">
                                        <p class="fl-left">
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text5">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text5 ft-txt-disab">
                                        <p class="fl-left">
                                            We at Home Credit are committed to ensure that the all details of your smartphone loan or tablet loan have been accurately communicated and captured. While taking a loan from Home Credit, our representatives will make it a point to explain all the details related to your loan clearly and transparently. When taking mobile phone finance from Home Credit, you will receive a welcome kit including a Loan Summary that will contain all details such as such as loan amount, due date and monthly installment amount.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text6">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text6 ft-txt-disab">
                                        <p class="fl-left">
                                            Our friendly and multi lingual customer care staff is always just a call away at 1800 121 6660 to guide you along and help you with your mobile phone loan. The Home Credit call center team reaches out to you in the language of your comfort and takes care to be your guiding partner throughout your loan tenure.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="feature-btns fl-right ft-close" data-target="text7">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text text7 ft-txt-disab">
                                        <p class="fl-left">
                            ...
                            <a href="applynow.jsp" id="feature-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
            ...
            <section class="row sec-pad-bt">
                <div class="row section-inr bg-r">
                    ...
                    <div class="block-30 block-100-t block-100-m block-left">

                        <span class="content-bord cont-bord-wht cont-bord-mar fl-left">
                        </span>

                        <h2 class="content-titl content-titl-w row">
                            Mobile Phone<br>
                            Insurance
                        </h2>
                    </div>

                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">

                        <!--feature list begins-->
                            <ul id="loan-features" class="row">
                                <li>
                                    <div class="row">
                                        <div class="fl-left feature-point-r">
                                            Can you imagine your life without a Mobile Phone?
                                        </div>
                                    </div>

                                    <div class="row feature-text-b">
                                        <p class="fl-left">
                                            You don't need to. Luckily, Home Credit Mobile Protection plan is there to help. Mobile 
                                            protection gives you peace of mind and gets you back on track by offering replacements 
                                            in case of theft and repair charges for damaged phones. Add Mobile Protection Plan to the purchase 
                                            of a new phone with Home Credit and pay the entire amount in easy EMIs.
                                            <br><br>
                                            
                                            — Cashless process<br>
                                            — Like for like replacement<br>
                                            — Zero deduction<br>
                                            — Free pick &amp; drop
                                ...
                                <li>
                                    <div class="row">
                                        <div class="fl-left feature-point-r">
                                            — Coverage of protect plus
                                        </div>

                                        <div id="feature-btns" class="fl-right ft-close" data-target="text1">
                                            <img src="images/feat-open-r.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close-r.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text-b text1 ft-txt-disab">
                                        <p class="fl-left">
                                            — Robbery, Snatch &amp; Theft<br>
                                            — Breakage &amp; Accidental damage<br>
                                            — Liquid damage
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div id="feature-btns" class="fl-right ft-close" data-target="text2">
                                            <img src="images/feat-open-r.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close-r.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text-b text2 ft-txt-disab">
                                        <p class="fl-left">
                                            — Breakage &amp; Accidental damage<br>
                                            — Liquid damage
                                        </p>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="fl-left feature-point-r">
                                            — Key benefits of protect plus &amp; protect
                                        </div>

                                        <div id="feature-btns" class="fl-right ft-close" data-target="text3">
                                            <img src="images/feat-open-r.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close-r.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>

                                    <div class="row feature-text-b text3 ft-txt-disab">
                                        <p class="fl-left">
                                            — Free pick-up and delivery service<br>
                                            — Cashless claims process.<br>
                                            — Replacement with new phone<br>
                            ...
                            <!--apply for mobile insurance button-->
                            <a href="https://www.homecredit.co.in/hco/loans/mobile-insurance.aspx" target="_blank" id="contact-click-here" class="common-apply-now-r fl-left btn-bt-mar">APPLY FOR CLAIMS</a>
                    </div>
