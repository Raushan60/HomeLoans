        ...
        <header id="header" class="row">
            <nav id="navbar" class="row height-100 navbar-s navbar-light">
                ...
                <div id="logo" class="fl-left height-100">
                    <a href="index.jsp" class="row height-100">
                ...
                <div id="nav-link-cont" class="fl-left">
                    <ul id="nav-links-basic" class="row">
                        ...
                        <li>
                            <a href="products.jsp" id="product">Products</a>
                        </li>
                        
                        <li>
                            <a href="careers.jsp" id="careers">Careers</a>
                        </li>
                        
                        <li>
                            <a href="contact-us.jsp" id="contact">Contact Us</a>
                ...
                <div id="other-ops-cont" class="fl-left v-center">
                    <ul id="other-ops" class="row">
                        ...
                        <li id="open-login" class="header-icon-bord disab">
                            <!--<img src="https://www.homecredit.co.in/visual/icons/login.png" class="header-icon other-icon other-icon-disab" alt="hc-login">-->
                        ...
                        <li id="share-module">
                            <!--<img src="https://www.homecredit.co.in/visual/icons/heart.png" class="header-icon-bord  header-icon other-icon other-icon-disab" alt="hc-share">-->
                    ...
                    <div class="row talign-cent">
                        <div id="menu-icon" class="menu-icon-c">
                            <div class="menu-icon-inr row m-open-icon">
                                <img src="https://www.homecredit.co.in/visual/icons/menu.png" alt="hc-menu" class="row other-icon-disab">
                            </div>
                            
                            <div class="menu-icon-inr row m-close-icon">
                                <img src="https://www.homecredit.co.in/visual/icons/close_icon_w.png" alt="hc-menu" class="row other-icon-disab">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="search-field-cont" class="row disab-opa disab-out search-module">
                <div id="search-field-mag" class="fl-left height-100 search-field-icon">
                    <img src="https://www.homecredit.co.in/visual/icons/search.png" class="row">
                </div>
                ...
                <div id="search-field-cross" class="fl-right height-100 search-field-icon close-search">
                    <img src="https://www.homecredit.co.in/visual/icons/close.png" class="row">
                </div>
        ...
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    ...
                    <h1 id="ban-main-titl" class="row">About us</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">We are one of India’s leading consumer finance provider.</p>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           Home Credit is one of India’s fastest growing non-banking financial company with operations in 77 cities, across 15 states and 11,000 points-of-sale (PoS) through which we cater to over 3 million customers. We are committed to drive credit penetration and financial inclusion by offering financial solutions that are simple, transparent and accessible to all.  Home Credit India has also been recognized by Aon Hewitt as a 'Regional AON Best Employer 2017' for employer excellence.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div class="row section-inr bg-r">
                    ...
                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">
                        <p class="content-text content-text-r row">
                           Home Credit offers easy, simple and fast loans for a range of Home Appliances, Mobile Phones, Laptops, Two Wheelers , and varied personal  needs. Typically, the first touchpoint for us to connect with our customers is through a PoS, that offers loans which are:
                        </p>
                            ...
                            <ul id="loan-features" class="row">
                                <li>
                                    ...
                                    <div class="row feature-text-b text1 ft-txt-disab">
                                        <p class="fl-left">
                                            Applying for a loan with us is incredibly easy. We do not require that you should have taken a loan in the past or should even own a credit card to apply for a loan. Even if this is your first loan ever, we encourage you to apply to Home Credit to make your dreams come true. 
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text2 ft-txt-disab">
                                        <p class="fl-left">
                                            At Home Credit, we’ve made our entire loan application process easy to understand. Especially for first time loan-takers, our clear and transparent terms and conditions and friendly multi-lingual customer care make understanding the world of finance so easy! Not only do we partner you through your loan process, but help you build your overall credit score, making finance easily accessible to you in the future.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text3 ft-txt-disab">
                                        <p class="fl-left">
                                            At Home Credit, we aim to minimize your waiting time through the loan process. With easy documentation requirements (only an address and ID proof), you can apply for a loan instantly!
                                        </p>
                                    </div>
                                </li>
                            </ul>
            ...
            <!--bottom section-->
            <section class="row narrow-row">
                <div class="row bt-sec-clean">
                    <div class="block-35 block-100-t block-100-m block-left">
                        <span class="content-bord cont-bord-red cont-bord-mar fl-left">
                        </span>
                    ...
                    <div class="block-65 block-100-t block-100-m block-left">
                        <ul id="loan-features" class="row">
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt"> Visit a Home Credit partner store and choose a product for purchase.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span> 
                                            <span class="fl-left feature-point-txt"> Meet the Home Credit representative who will help fill out your loan application form.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt"> Home Credit evaluates the application based on internal guidelines.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt"> Once accepted, you can decide on your monthly repayment amount, sign the agreement and make the down payment.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt"> Take your new purchase home the very same day !</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt"> Don't forget to make your monthly payments amount before the due date using our easy repayment options.</span>
                                        </div>
                                    </div>
