...
<head>
    ...
    <link href="css?family=Lora:400,400i,700,700i" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            #main-banner{
                background-image:url('images/mini-cash-loan.jpg')
            }
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/mini-cash-loan-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Instant Loan at</span>
                    <h1 id="ban-main-titl" class="row">YOUR FINGERTIPS.</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Get cash for urgent needs that come-up without a warning.</p>
                    <a href="https://www.homecredit.co.in/mcl" target="_blank" id="banner-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
            ...
            <!--loan video section-->
            <!--<section  class="row">
                <div id="loan-video-main" class="row">

                    <div id="loan-video" class="row">
                        <video id="featured-video"  class="row" loop>
                          <source src="https://www.homecredit.co.in/visual/video/hcVid.mp4" type="video/mp4">
                          Please use some better browser to view this video.
                        </video>
                    </div>

                    <div id="loan-video-controls" class="row video-paused talign-cent">  
                        <div id="control-cont" class="row">
                            <img src="images/loan/play.png" id="play-btn" class="play-btn-s play-btn-curs">
                            <span id="video-title" class="row">CLICK-A-LOAN</span>
                            <div class="row">
                                <a href="#" id="banner-apply-now" class="common-apply-now fl-left video-click">CLICK HERE</a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="product-feature-inr" class="row">
                    ...
                    <div id="product-features" class="row">
                        <div id="feature-left" class="fl-left">
                            ...
                            <!--cash loan features list with icons-->
                            <ul id="cash-loan-feat" class="row">
                                <li>
                                    <div class="fl-left feat-list-icon">
                                        <img src="images/icon1.png" alt="homeCredit">
                                    </div>

                                    <div class="fl-left feat-list-text">
                        ...
                        <div id="feature-right" class="fl-left">
                            ...
                            <ul id="loan-features" class="row">
                                ...
                                <!--<li>
                                    <div class="row">
                                        ...
                                        <div id="feature-btns" class="fl-right ft-close" data-target="text7">
                                            <img src="images/feat-open.png" class="row" id="ft-opn-btn">
                                            <img src="images/feat-close.png" class="row" id="ft-cls-btn">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row feature-text text7 ft-txt-disab">
                                        <p class="fl-left">
                                            With Home Credit's easy mobile phone finance, you can take home your dream phone or tablet today and pay back the loan amount monthly.
                                        </p>
                                    </div>
                                </li>-->
                            </ul>
                            ...
                            <a href="https://www.homecredit.co.in/mcl" target="_blank" id="feature-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
