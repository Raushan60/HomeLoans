...
<head>
    ...
    <meta name="csrf-token" content="IHvgLsNEluKr7W7vlj1YeegxEIm4ydQMCrjWE9cL" />
        ...
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Simply</span>
                    <h1 id="ban-main-titl" class="row">APPLY FOR LOAN</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">With our quick and simple process getting a loan for your needs is quite simple indeed.</p>
                    <!--<a href="https://homecredit.co.in/loans/applyforloans.aspx" target="_blank" id="banner-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>-->
            ...
            <section id="apply-now-form-cont" class="row sec-pad-bt">
                <div id="apply-now-form-inr" class="row narrow-row">
                    <form method="post" action="apply_for_loan.jsp" id="apply-now-form" class="row">
                        
                        <div class="row">
                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="text" name="name" placeholder="Name*" required>
                            </div>

                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="email" id="apply-email" name="email" placeholder="Email*" required>
                            </div>
                        </div>    
                        ...
                        <div class="row">
                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="tel" id="apply-phone" name="phoneno" placeholder="Phone*" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="text" id="apply-state" name="state" placeholder="State*" required>
                            </div>

                            <div class="form-inp-block block-50 block-100-m block-100-t block-left">
                                <input type="text" id="apply-city" name="city" placeholder="City*" required>
                            </div>
                        </div>
                        
                        <div class="row apply-other-cont">
                            <div id="apply-check" class="fl-left">
                                <input type="checkbox" name="status" id="apply-term" required>
                            </div>
                            
                            <div id="apply-label" class="fl-left">
                                <label>
                                    I declare that the information I have provided above is accurate and complete to the best of my knowledge. I authorize Home Credit &amp; its representatives to call, email or SMS me with reference to my loan application.
                                </label>
                            </div>
                        </div>
