...
<body>
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            #main-banner{
                background-image:url('images/customer-promise.jpg')
            }
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/customer-promise-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Our</span>
                    <h1 id="ban-main-titl" class="row">commitment</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Our loans are here to help you afford the things you need.</p>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           At Home Credit, we are committed to make your shopping and repayment as smooth as possible. We are committed to make your loan experience an informed and pleasant one. It is a sincere commitment to each one of you that we will go beyond the call of duty to make your experience with Home Credit, memorable. 
                        </p>
                    </div>
                </div>
            </section>

            <!--customer promise second section--> 
            <section class="row">
                <div class="row section-inr bg-r sec-pad-bt">
                            ...
                            <ul id="loan-features" class="row">
                                <li>
                                    ...
                                    <div class="row feature-text-b text1 ft-txt-disab">
                                        <p class="fl-left">
                                            We offer full transparency on our products.  That means no hidden charges and all information  about loan is disclosed up front.<br><br>

                                            You can check your loan details anytime through  our mobile app. We offer a 15-day guarantee period in case you have a change of heart.<br><br>
                                            We keep all your personal information strictly confidential.
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text2 ft-txt-disab">
                                        <p class="fl-left">
                                            We will be happy to answer all of you questions and explain the conditions of the loan in detail.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text3 ft-txt-disab">
                                        <p class="fl-left">
                                            To help you pay on time and avoid late payment penalties,  we’ll be sending polite reminders about your due date.<br><br>
                                            We ensure fast response for all your concerns.
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text4 ft-txt-disab">
                                        <p class="fl-left">
                                            In cases of immediate need we will support you by offering repayment solutions.<br> 

                                            You can get in touch with us via our call centre, email or Facebook, mobile app and website.
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text5 ft-txt-disab">
                                        <p class="fl-left">
                                           We can tailor-fit instalment plans to match your needs. Just make sure all your information is correct, up to date and accurate.
                                        </p>
                                    </div>
                                </li>
            ...
            <!--customer promise third section-->
            <section id="main-content" class="row narrow-row">
                <div id="main-content-inner" class="row">
                    <div class="block-35 block-100-t block-100-m block-left content-block">
                        <span class="content-bord cont-bord-red cont-bord-mar fl-left">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           Home Credit is sincerely committed in ensuring each customer has a superior experience with us. We have a “15 Day Guarantee” which entitles you to a right to withdraw from the financing agreement within the first 15 days of your loan with Home Credit, in case you feel that we have not lived up to your expectations.<br>
                            For more details, please call us at 1800 121 6660 and one of our customer service representatives will walk you through the process.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <!--customer promise fourth section--> 
            <section class="row sec-pad-bt">
                <div class="row section-inr bg-r">
                    ...
                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">
                        <p class="content-text content-text-b row">
                           To be fair, we have created the position of “Ombudsperson” in Home Credit. If you feel that your concern has not been fairly addressed or has been ignored or we have failed to comply with some of the principles that we commit to, you can write to the Ombuds office which will resolve your issue in a manner that complies with our values of being confidential, neutral, independent and informal.<br><a href="https://www.homecredit.co.in/hco/ombudsperson.aspx" target="_blank" class="link-r">Click here to know more..</a>
                        </p>
                        ...
                        <ul id="loan-features" class="row">
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            ...
                                            <span class="fl-left feature-point-txt">Treat our staff with respect.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span> 
                                            <span class="fl-left feature-point-txt">Pay your monthly instalments on or before your due date and through Home Credit approved payment channels.</span>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="row feature-point-b">
                                            <span class="fl-left">—</span>
                                            <span class="fl-left feature-point-txt">Keep us informed in case of any change in your financial or personal information.</span>
                                        </div>
                                    </div>
