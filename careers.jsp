                ...
                <ul id="mob-menu-ul" class="row">
                    ...
                    <li>
                        ...
                        <div class="row feature-text text103 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                <li>
                                    <a href="careers.jsp" class="menu-inr-link">— WHY JOIN US</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="client.jsp" target="_blank" class="menu-inr-link">— CURRENT OPENINGS</a>
                                </li>                                
                            </ul>
                        </div>
                    </li>
                    ...
                    <ul id="mob-menu-ul" class="row v-center">
                        ...
                        <li>
                            ...
                            <div class="row feature-text text122 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    <li>
                                        <a href="careers.jsp" class="dmenu-inr-link">— WHY JOIN US</a>
                                    </li>
                                    <li>
                                        <a href="our-vision.jsp" class="dmenu-inr-link">— VISION &amp; VALUES</a>
                                    </li>
                                    <li>
                                        <a href="our-people.jsp" class="dmenu-inr-link">— OUR PEOPLE</a>
                                    </li>
                                    <li>
                                        <a href="lifeathc.jsp" class="dmenu-inr-link">— LIFE @ HOMECREDIT</a>
                                    </li>
                                    <li>
                                        <a href="client.jsp" target="_blank" class="menu-inr-link">— CURRENT OPENINGS</a>
                                    </li>                                
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            ...
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/careers-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">We are people with passion for</span>
                    <h1 id="ban-main-titl" class="row">excellence</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">We enable innovative and energetic people to unleash their potential to become part of our performance driven culture.</p>
                    <a href="client.jsp" target="_blank" id="banner-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
                    ...
                    <ul id="abt-nav-dot-cont" class="row">
                        <li class="abt-dot-btn abt-dot-actv">
                            <a href="/careers">
                                ...
                                <span class="abt-dot-titl fl-left">Why Join Us</span>
                            </a>    
                        </li>
                        ...
                        <li class="abt-dot-btn abt-dot-disab">
                            <a href="/lifeathc">
                                <span  class="abt-dot"></span>
                                <span class="abt-dot-titl fl-left">Life @ HomeCredit</span>
                            </a>    
                        </li>

                        <li class="abt-dot-btn abt-dot-disab">
                            <a href="client.jsp" target="_blank">
                                <span  class="abt-dot"></span>
                                <span class="abt-dot-titl fl-left">Current Openings</span>
                            </a>
                        </li>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                            We believe in speed, which can be seen by the way we’ve grown over the years. We are a team of 16,000 proficient and progressive employees who possess strong entrepreneurial spirit. Joining us will assure you to work with a highly talented and culturally diverse workforce. This is the place where you get the opportunity to challenge yourself and learn new skills everyday.<br><br>
                            "We are always in search of energetic and innovative individuals who would like to explore their career with an exponentially growing company. If you are the one, we want to talk to you!"
            ...
            <section class="row sec-pad-bt">
                <div class="row section-inr bg-r">
                    ...
                    <div class="block-70 block-100-t block-100-m block-left bg-w sec-inr-block-rt">
                        <p class="content-text content-text-r row">
                           We at Home Credit believe that it is important for individual to see success. The organizational structure provided by us is the perfect amalgamation of checks and balances that ensure every individual reaches his/her highest potential.
                        </p>
                            ...
                            <ul id="loan-features" class="row">
                                <li>
                                    ...
                                    <div class="row feature-text-b text1 ft-txt-disab">
                                        <p class="fl-left">
                                            We want our employees to live up to their full potential, and telling them what to do, how to do, and when to do is not our approach. Our employees make their own goals, which gives them intrinsic motivation – the desire to do something for their own sake.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text2 ft-txt-disab">
                                        <p class="fl-left">
                                            Every individual’s contribution counts in the organization, and we recognize their contributions with a positive and innovative organizational climate overall. Our remuneration packages are based on the performance of both the employee and the company through a fixed and performance-related element. Our monthly incentive plans, annual bonus policy and additional rewards and recognition makes working at Home Credit a fulfilling and motivating experience. 
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text3 ft-txt-disab">
                                        <p class="fl-left">
                                            We focus on progressive education and development which helps in the professional growth of our employees at all levels. The development objective focuses on enabling growth and performance of the employees and the organization by creating a culture of learning that drives the values, actions and practices supporting Home Credit India’s vision. We foster employees’ career development by offering training programs. Periodic role-based functional and soft skills training as well as Management Development Programmes will help you upgrade your skills and stay ahead of the curve.
                                        </p>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="row feature-text-b text4 ft-txt-disab">
                                        <p class="fl-left">
                                            While our employees work hardest for better results, we trust and empower them to make decisions and solve problems. With this trust and authority, our employees feel proud of their work and workplace. We believe that at Home Credit, you can always make it better.
                                        </p>
                                    </div>
                                </li>
                            </ul>
                ...
                <div id="footer-bottom-bar" class="row">
                    <div class="-fl-left">
                        <ul id="bottom-links" class="fl-left bottom-links-common">
                            ...
                            <li>
                                <a href="imag/rbi-disclaimer.jpg" target="_blank">
                                    RBI DISCLAIMER
                                </a>
                            </li>
