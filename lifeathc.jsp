                ...
                <ul id="mob-menu-ul" class="row">
                    ...
                    <li>
                        ...
                        <div class="row feature-text text106 ft-txt-disab">
                            <ul class="menu-inr-links row">
                                <li>
                                    <a href="contact-us.jsp" class="menu-inr-link">— CUSTOMER</a>
                                </li>
                                <li>
                                    <a href="partner.jsp" class="menu-inr-link">— PARTNER</a>
                                </li>
                                <li>
                                    <a href="employee.jsp" class="menu-inr-link">— EMPLOYEE</a>
                                </li>
                                <li>
                    ...
                    <ul id="mob-menu-ul" class="row v-center">
                        ...
                        <li>
                            ...
                            <div class="row feature-text text125 ft-txt-disab">
                                <ul class="dmenu-inr-links row">
                                    <li>
                                        <a href="contact-us.jsp" class="dmenu-inr-link">— CUSTOMER</a>
                                    </li>
                                    <li>
                                        <a href="partner.jsp" class="dmenu-inr-link">— PARTNER</a>
                                    </li>
                                    <li>
                                        <a href="employeehtml" class="dmenu-inr-link">— EMPLOYEE</a>
                                    </li>
                                    <li>
    ...
    <div id="wrapper" class="row disab-opa">
        ...
        <style>
            ...
            @media  only screen and (min-width:280px) and (max-width:1023px) and (orientation:portrait){
                #main-banner{
                    background-image:url('images/life-m.jpg')
                }
            }
        </style>
        <!--======main body begins======-->
        <main id="main" class="row disable-popup">
            ...
            <section id="main-banner" class="row">
                <div id="banner-info" class="row">
                    <span id="ban-titl" class="row">Come,</span>
                    <h1 id="ban-main-titl" class="row">Work With Us!</h1>
                    <span class="content-bord cont-bord-wht cont-bord-mar fl-left"></span>
                    <p id="banner-text" class="fl-left clear-all">Be a part of the global Home Credit family of 100,000 people across 11 countries.</p>
                    <a href="https://homecredit.co.in/portals/cp/client/default.aspx" target="_blank" id="banner-apply-now" class="common-apply-now fl-left clear-all">APPLY NOW</a>
                ...
                <div id="abt-nav-dots" class="fl-left">
                    ...
                    <ul id="abt-nav-dot-cont" class="row">
                        ...
                        <li class="abt-dot-btn abt-dot-disab">
                            <a href="https://homecredit.co.in/portals/cp/client/default.aspx" target="_blank">
                                <span  class="abt-dot"></span>
                ...
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           We have a cross cultural and multi-national environment with our global presence. We give our employees the freedom and choice to shape their approach and suit their preferences and abilities  by giving them a heightened sense of control over the situation.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id="main-content" class="row narrow-row">
                <div id="main-content-inner" class="row">
                    ...
                    <div class="block-65 block-100-t block-100-m block-left content-block">
                        <p class="content-text content-text-b row">
                           We have been recognized by Aon Hewitt as Best Employer 2017 for employer excellence. We continuously strive towards providing a conducive, culturally inclusive and growth-oriented work atmosphere and environment to our strong employee base. Our employees are the cornerstone of the success we have received over the last five years. At Home Credit India, we strive to offer long-term, stable and interesting employment.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <!--life at HC slides-->
            <section id="lifeathc" class="row sec-pad-bt">
                <div class="row section-inr-2 section-inr bg-r">
                    <div class="block-30 block-100-t block-100-m block-left section-inr-m-pad">
                    ...
                    <div class="block-60 block-100-t block-100-m block-left">
                        <div class="row bg-w">
                            <div id="life-slide-main" class="row">
                                <ul id="life-slides" class="fl-left life-slider-trans">
                                    <!--life at home credit slides-->
                                    <li class="life-slide">
                                        <div class="life-slide-img">
                                            <img src="images/01.jpg">
                                        </div>

                                        <div class="life-slide-cap">
                                            <p>
                                                Diwali celebrated at Home Credit with great gusto!
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                Winners of the first MY Home Credit TT Championship
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                The Home Credit TT Championship saw enthusiastic participation of over 70 employees across offices
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                The monthly Open House at Home Credit is a platform for leadership communication as well as announcements and fun and games!
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                An impromptu "flash mob" at the monthly Open House by members of a team!
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                Leadership communication on company news and strategy delivered at the monthly Open House.
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                The "MY Home Credit Cricket Tournament"; a huge hit with employees across teams and locations
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                Winners of the "MY Home Credit Cricket Tournament" celebrating their success
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                To bring in the new year, Home Credit employees spread warmth by donating old clothes and blankets to the underprivileged
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                The Diwali Talent show saw great participation and enthusiastic response at Home Credit
                                            </p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="life-slide">
                                        ...
                                        <div class="life-slide-cap">
                                            <p>
                                                The lively Home Credit contingent at the Delhi Marathon
                                            </p>
                                        </div>
                                    </li>
                        ...
                        <div id="lifeSliderControls" class="row no-select">
                            <span id="life-prev-btn" class="life-btns">Prev</span>
                            <span id="life-next-btn" class="life-btns">Next</span>
                        </div>
